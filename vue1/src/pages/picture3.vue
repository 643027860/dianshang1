    ...
    methods: {
          ...
          if(!canvas){
            ...
            img.onload = function(){
              ...
              canvas.addEventListener('mouseup',(event)=>{
                console.log('a')
                console.log(_this.choicePoint)
                if(_this.choicePoint){
                  console.log('b')
                  _this.choicePoint.style.border = ''
              ...
              canvas.addEventListener('mousemove',(e)=>{
                if(_this.choicePoint) {
                  ...
                  _this.choicePoint.style.left = x1-4+'px'
                  _this.choicePoint.style.top = y1-4+'px'
                }
              })
            }
      ...
      checkPointer(event){
        ...
        oTip.addEventListener('mousedown',(event)=>{
          oTip.style.border = '1px solid blue'
